...
using GameFrameworkDebugger.Runtime;
using UnityEngine;
...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class DebuggerComponent : MonoBehaviour
    {
        ...
        /// 默认调试器漂浮框大小。
        /// </summary>
        internal static readonly Rect DefaultIconRect = new Rect(10, Screen.height/2f, 60f, 60f);

        /// <summary>
        /// 默认调试器窗口大小。
        /// </summary>
        internal static readonly Rect DefaultWindowRect = new Rect(10f, 10f, 1280, 720);
        ...
        private LogChannelWindow m_LogChannelWindow = new LogChannelWindow();
        private SlotWindow m_SlotWindow = new SlotWindow(new SlotGameDebugger());
        private SwapSceneWindow m_SwapSceneWindow = new SwapSceneWindow();
        private ChangeMedalWindow m_ChangeMedalWindow = new ChangeMedalWindow();
       ...
       //private InputLocationInformationWindow m_InputLocationInformationWindow = new InputLocationInformationWindow();
        ...
        private void Start()
        {
            ...
            RegisterDebuggerWindow("LogChannel", m_LogChannelWindow);
            RegisterDebuggerWindow("Slot/Normal",m_SlotWindow);
            RegisterDebuggerWindow("Slot/SwapScene", m_SwapSceneWindow);
            RegisterDebuggerWindow("Slot/Medal", m_ChangeMedalWindow);
