...
namespace UnityEditor.XCodeEditor
{
	public class PBXFileReference : PBXObject
	{
		...
		public static readonly Dictionary<string, string> typePhases = new Dictionary<string, string> {
			...
			{ ".ya", "PBXResourcesBuildPhase" },
			{ ".so", "PBXResourcesBuildPhase" },
			{ ".sa", "PBXResourcesBuildPhase" },
			{ ".pa", "PBXResourcesBuildPhase" }
    	};
		...
		public PBXFileReference( string filePath, TreeEnum tree = TreeEnum.SOURCE_ROOT, string compilerFlags = null ) : base()
		{
