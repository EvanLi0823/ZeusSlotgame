...
public class CircleImage : BaseImage {
    ...
    [Tooltip("启用动态刷新顶点")]
    public bool enableDynamicFresh = false;
    [Tooltip("是否填充圆形")]
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        Debug.Log("rectTransform.localEulerAngles.z:" + rectTransform.localEulerAngles.z);
        float finalStartDegree = rectTransform.localEulerAngles.z/180f;
        Debug.Log("Start Ratio:"+finalStartDegree);
        float curDegree = - Mathf.PI *finalStartDegree;
