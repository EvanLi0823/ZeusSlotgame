...
namespace UnityEngine.UI.Extensions
{
	...
	public class UILineRenderer : UIPrimitiveBase
	{
        ...
        protected const float MIN_MITER_JOIN = 15 * Mathf.Deg2Rad;
        ...
        protected const float MIN_BEVEL_NICE_JOIN = 30 * Mathf.Deg2Rad;
        ...
        protected UIVertex[] CreateLineCap(Vector2 start, Vector2 end, SegmentType type)
		{
        ...
        protected UIVertex[] CreateLineSegment(Vector2 start, Vector2 end, SegmentType type)
		{
			var uvs = middleUvs;
			if (type == SegmentType.Start)
				uvs = startUvs;
