...
namespace CSFramework {
	public class SGLineRenderer : MaskableGraphic {
		...
		public override Texture mainTexture { get { return m_Texture == null ? s_WhiteTexture : m_Texture; } }
		...
		protected override void OnPopulateMesh(VertexHelper vh) {
			...
			if (Points == null || Points.Length < 2) Points = new[] {new Vector2(0, 0), new Vector2(1, 1)};
			var capSize = 24;
			...
			Debug.Log (sizeX + "  " + sizeY+ "  " + offsetX+ "  " + offsetY);
			...
			for (int i = 1; i < TempPoints.Length; i++) {
				...
				if (i == 1) uvs = new[] {uvTopLeft, uvBottomLeft, uvBottomCenter, uvTopCenter};
				else if (i == TempPoints.Length - 1) uvs = new[] {uvTopCenter, uvBottomCenter, uvBottomRight, uvTopRight};
